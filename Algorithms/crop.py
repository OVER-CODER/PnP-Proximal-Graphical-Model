...
# Load the image
image_path = "demosaic_benign-132.jpg"  # Change this to your file path
...
box_size = 1436
left_start = - (int(2 * width / 3) + (width // 6) - (685 // 2) - 5700) # Centered in rightmost third
...
cv2.imwrite("cropped_img_left.png", cropped_image, [cv2.IMWRITE_PNG_COMPRESSION, 0])
